  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
      <Reveal>
        <SectionHeading
          eyebrow="About Us"
          title="About Easy Toddler Day"
          subtitle="Screen-free learning, made joyful — one workbook at a time."
        />
      </Reveal>

      <Reveal delay={0.1}>
        <div className="mx-auto mt-10 flex max-w-2xl flex-col gap-4 text-center text-lg text-warm-gray">
          <p>
          ...
          <p>
            ...
            subscriptions to manage — just paper, crayons, and a toddler who
            feels proud of what they made.
          </p>
        </div>
      </Reveal>
